...
import { Keyboard, View, Platform, useWindowDimensions, Text, TextInput, ActivityIndicator, Pressable, TouchableWithoutFeedback } from 'react-native';
                                ...
                                {openPicker === 'permission' ? (
                                    ...
                                    <>
                                        ...
                                        <View style={styles.overlaySection}>
                                            ...
                                            {availableModels.length > 0 ? visibleModels.map((model) => {
